...
# This one is a dummy (D stands for dummy), it is a fix for the bug where the selectStatementWithLimit cannot be read
selectStatementWithLimitD
SELECT S.Subj, S.Prop, S.Obj
FROM ${a} S WHERE S.GraphID = ? ORDER BY S.Subj ASC LIMIT ?, ?
...
selectStatementWithLimitS
SELECT S.Subj, S.Prop, S.Obj
FROM ${a} S WHERE S.Subj = ? AND S.GraphID = ? ORDER BY S.Subj ASC LIMIT ?, ?

#-------------------------------------------------------------------
# Select all the statements in an Asserted Statement (triple store) graph
# with the same subject and Property
selectStatementWithLimitSP
SELECT S.Subj, S.Prop, S.Obj
FROM ${a} S WHERE S.Subj = ? AND S.Prop = ? AND S.GraphID = ? ORDER BY S.Subj ASC LIMIT ?, ?

#-------------------------------------------------------------------
# Select all the statements in an Asserted Statement (triple store) graph
# with the same subject and Property and object
selectStatementWithLimitSPO
SELECT S.Subj, S.Prop, S.Obj
FROM ${a} S WHERE S.Obj = ? AND S.Subj = ? AND S.Prop = ? AND S.GraphID = ? ORDER BY S.Subj ASC LIMIT ?, ?

#-------------------------------------------------------------------
# Select all the statements in an Asserted Statement (triple store) graph
# with the same subject and Object
selectStatementWithLimitSO
SELECT S.Subj, S.Prop, S.Obj
FROM ${a} S WHERE S.Obj = ? AND S.Subj = ? AND S.GraphID = ? ORDER BY S.Subj ASC LIMIT ?, ?

#-------------------------------------------------------------------
# Select all the statements in an Asserted Statement (triple store) graph
# with the same Property and Object
selectStatementWithLimitPO
SELECT S.Subj, S.Prop, S.Obj
FROM ${a} S WHERE S.Obj = ? AND S.Prop = ? AND S.GraphID = ? ORDER BY S.Obj ASC LIMIT ?, ?

#-------------------------------------------------------------------
# Select all the statements in an Asserted Statement (triple store) graph
# with the same Object
selectStatementWithLimitO
SELECT S.Subj, S.Prop, S.Obj
FROM ${a} S WHERE S.Obj = ? AND S.GraphID = ? ORDER BY S.Obj ASC LIMIT ?, ?

#-------------------------------------------------------------------
# Select all the statements in an Asserted Statement (triple store) graph
# with the same Property
selectStatementWithLimitP
SELECT S.Subj, S.Prop, S.Obj
FROM ${a} S WHERE S.Prop = ? AND S.GraphID = ? LIMIT ?, ?

#-------------------------------------------------------------------
# Select all the statement URI's in a Reified Statement (triple store) graph
# that partially reify something
selectReifNodeWithLimit
SELECT DISTINCT S.Stmt
FROM ${a} S WHERE S.GraphID = ? ORDER BY S.Stmt ASC LIMIT ?, ?

#-------------------------------------------------------------------
# Determine if the statement URI's partially reifies anything in a Reified
# Statement (triple store) graph
selectReifNodeWithLimitN
SELECT DISTINCT S.Stmt
FROM ${a} S WHERE S.Stmt = ? AND S.GraphID = ? ORDER BY S.Stmt ASC LIMIT ?, ?

#-------------------------------------------------------------------
# Select all the statement URI's in a Reified Statement (triple store) graph 
# with the specified subject, property and literal (resource)
selectReifNodeWithLimitSPOT
SELECT S.Stmt
FROM ${a} S WHERE S.Subj = ? AND S.Prop = ? and S.Obj = ? AND S.GraphID = ? AND S.HasType = 'T' ORDER BY S.Stmt ASC LIMIT ?, ?

#-------------------------------------------------------------------
# Select all the statement URI's in a Reified Statement (triple store) graph
# with the specified subject, property and literal (reference)
selectReifNodeWithLimitT
SELECT S.Stmt
FROM ${a} S WHERE S.GraphID = ? AND S.HasType = 'T' ORDER BY S.Stmt LIMIT ?, ?

# Addition by Farhan ends here
#
